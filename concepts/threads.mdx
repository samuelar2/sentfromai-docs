...
description: 'How SentFromAI groups a back-and-forth into a single conversation.'
---

A **thread** is one conversation. SentFromAI reconstructs threads from RFC-5322
...
```bash
curl "https://…/v1/threads?inbox_id=INBOX_ID&limit=25" -H "Authorization: Bearer sf_live_…"
```
...
```json
{
  ...
  "messages": [
    ...
    { "id": "m_2", "direction": "outbound", "from_addr": "support-bot@mail.sentfrom.ai",
...
When you [reply or forward](/concepts/sending), SentFromAI sets the threading headers
